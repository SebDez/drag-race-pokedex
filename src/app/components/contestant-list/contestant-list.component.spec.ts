...
describe('ContestantListComponent', () => {
  ...
  it('should create', () => {
    ...
    fixture.componentRef.setInput('contestants', []);
    fixture.detectChanges();
    expect(fixture.componentInstance).toBeTruthy();
  });

  it('should render no cards when contestants is empty', () => {
    const fixture = TestBed.createComponent(ContestantListComponent);
    fixture.componentRef.setInput('contestants', []);
    fixture.detectChanges();
  ...
  it('should render one card per contestant', () => {
    const contestants = [
      createContestant({ dragName: 'Queen A' }),
      createContestant({ dragName: 'Queen B' }),
    ];
    const fixture = TestBed.createComponent(ContestantListComponent);
    fixture.componentRef.setInput('contestants', contestants);
    fixture.detectChanges();
    const el = fixture.nativeElement as HTMLElement;
