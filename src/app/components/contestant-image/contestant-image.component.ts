...
/**
 * Contestant image: immediate placeholder, lazy loading and asynchronous decoding.
 * Native tag to keep fixed pixel sizes without constraints `sizes` / srcset of NgOptimizedImage.
 */
@Component({
