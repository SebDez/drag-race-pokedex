...
@Component({
  ...
  template: `@if (show()) {
    <span
      class="inline-flex items-center justify-center gap-1 h-8 font-semibold uppercase tracking-wider py-0 px-2 rounded-md bg-[var(--color-gold-light)] text-[var(--color-gold-dark)] "
